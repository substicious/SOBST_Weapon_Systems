    ...
    partial class Parts {
        ...
        WeaponDefinition HORNET_Turret => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                ...
                {
                    RateOfFire = 220, // Set this to 3600 for beam weapons. This is how fast your Gun fires.
                    ...
                    ShotsInBurst = 78, // Use this if you don't want the weapon to fire an entire physical magazine in one go. Should not be more than your magazine capacity.
            ...
            Ammos = new[] {
                StarStreakAmmo, // Must list all primary, shrapnel, and pattern ammos.
            },
