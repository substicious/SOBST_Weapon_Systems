...
{ // Don't edit above this line
    partial class Parts
    {
        private AmmoDef APBC_125MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "APBC_125MM_Shell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            Trajectory = new TrajectoryDef
            {
                ...
                DesiredSpeed = 1067, // voxel phasing if you go above 5100
            ...
            {
                ModelName = "\\Models\\Ammo\\APBC_ArmorPiercingBallisticCap_125mm_Shell.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 10f, //
                        Width = 0.5f, //
                        Color = Color(red: 0.2f, green: 0.2f, blue: 5f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
		...
		private AmmoDef HESH_125MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "HESH_125MM_Shell", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef HESH_125MM_FRAG => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
        ...
        private AmmoDef APBC_370MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "APBC_370_GOLIATH", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            ...
            AmmoGraphics = new GraphicDef
            {
                ...
                Lines = new LineDef
                {
                    ...
                    Tracer = new TracerBaseDef
                    {
                        ...
                        Length = 15f,
                        Width = 0.8f,
                        Color = Color(red: 0.9f, green: 0.9f, blue: 0.9f, alpha: 1), // RBG 255 is Neon Glowing, 100 is Quite Bright.
                        VisualFadeStart = 0, // Number of ticks the weapon has been firing before projectiles begin to fade their color
                        VisualFadeEnd = 0, // How many ticks after fade began before it will be invisible.
                        Textures = new[] {// WeaponLaser, ProjectileTrailLine, WarpBubble, etc..
                            "ProjectileTrailLine", // Please always have this Line set, if this Section is enabled.
        ...
        private AmmoDef APDU_370MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "APDU_370_GOLIATH", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
		...
		private AmmoDef HESH_370MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "HESH_500", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "370mm High Explosive Squash Head Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            ...
            Fragment = new FragmentDef // Formerly known as Shrapnel. Spawns specified ammo fragments on projectile death (via hit or detonation).
            {
                AmmoRound = "370mm HESH Fragments", // AmmoRound field of the ammo to spawn.
        ...
        private AmmoDef HESH_370MM_FRAG => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "370mm HESH Fragments", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
            BaseDamage = 3300f, // Direct damage; one steel plate is worth 100.
        ...
        private AmmoDef APPC_500MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "APPC_500", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef NUPC_500MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "NuPC_500", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "500mm Armor Nuclear Pin Capped Shell", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef HESH_500MM_Shell => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "HESH_500", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef HESH_500MM_FRAG => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "Energy", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
            AmmoRound = "500mm HESH Fragments", // Name of ammo in terminal, should be different for each ammo type used by the same weapon. Is used by Shrapnel.
            HybridRound = false, // Use both a physical ammo magazine and energy per shot.
            EnergyCost = 0.1f, // Scaler for energy per shot (EnergyCost * BaseDamage * (RateOfFire / 3600) * BarrelsPerShot * TrajectilesPerBarrel). Uses EffectStrength instead of BaseDamage if EWAR.
        ...
        private AmmoDef VULCAN => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40x127_VULCAN", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef VULCAN_DUR => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            AmmoMagazine = "40x127_VULCAN_DUR", // SubtypeId of physical ammo magazine. Use "Energy" for weapons without physical ammo.
        ...
        private AmmoDef MARLIN_57_HESH => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\MARLIN_57x438_HighExplosiveShell.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                VisualProbability = 1f, // %
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
        ...
        private AmmoDef CHURCHHILL_25MM => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\Type25_25x131_CHURCHHILL_Shell.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                VisualProbability = 1f, // %
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
        ...
        private AmmoDef HORNET_80x652_Standard => new AmmoDef // Your ID, for slotting into the Weapon CS
        {
            ...
            AmmoGraphics = new GraphicDef
            {
                ModelName = "\\Models\\Ammo\\HORNET_80x652mm_Standard.mwm", // Model Path goes here.  "\\Models\\Ammo\\Starcore_Arrow_Missile_Large"
                VisualProbability = 1f, // %
                ShieldHitDraw = true,
                Particles = new AmmoParticleDef
                {
            ...
            AmmoAudio = new AmmoAudioDef
            {
                TravelSound = "HeavyShellFlightSound", // SubtypeID for your Sound File. Travel, is sound generated around your Projectile in flight
                HitSound = "ArcImpMetalMetalCat0",
                ShotSound = "WepTurretMissileShot",
                ShieldHitSound = "",
                PlayerHitSound = "",
                VoxelHitSound = "",
                FloatingHitSound = "",
