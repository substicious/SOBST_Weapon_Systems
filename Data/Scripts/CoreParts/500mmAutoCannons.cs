...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition STORMFLY_500MM => new WeaponDefinition
        {
            ...
            HardPoint = new HardPointDef
            {
                PartName = "\"STORMFLY\" 500mm Triple AutoCannon", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
