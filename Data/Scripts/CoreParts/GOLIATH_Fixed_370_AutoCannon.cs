...
namespace Scripts {   
    partial class Parts {
        ...
        WeaponDefinition GOLIATH_370MM => new WeaponDefinition
        {
            Assignments = new ModelAssignmentsDef
            {
                MountPoints = new[] {
                    new MountPointDef {
                        SubtypeId = "GOLIATH_Fixed_370_AutoCannon", // Block Subtypeid. Your Cubeblocks contain this information
            ...
            {
                PartName = "GOLIATH Fixed Autocannon 370mm", // Name of the weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons).
                ...
                Audio = new HardPointAudioDef
                {
                    ...
                    FiringSound = "LittleDavid", // Audio for firing.
